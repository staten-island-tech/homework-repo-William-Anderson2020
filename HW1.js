...
function normandy(){
    let beach = 'gold';
    console.log(`Welcome to ${beach} landing zone.`)
}
normandy();

//console.log(beach); //won't work since beach is described in the function scope, not global.